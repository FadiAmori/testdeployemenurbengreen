<x-dashboard::layout bodyClass="bg-gray-200" titlePage="Edit Event" activePage="events" :showSidebar="true">
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-lg-6 col-md-8 col-12 mx-auto">
                <div class="card">
                    <div class="card-header pb-0">
                        <h6>Edit Event: {{ $event->title }}</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.event.update', $event) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($event->image)
                                    <p>Current: <img src="{{ Storage::url($event->image) }}" alt="Event Image" style="max-width:100px;"></p>
                                @endif
                            ...
                            <button type="submit" class="btn bg-gradient-success">Update Event</button>
                        </form>
                    </div>
                </div>
            </div>
